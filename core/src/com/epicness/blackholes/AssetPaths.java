...
public class AssetPaths {
    ...
    public static final String BLACK_HOLE_GLOW_PATH = "images/game/blackHole.png";
    public static final String INVERTED_BLACK_HOLE_PATH = "images/game/invertedBlackHole.png";
    public static final String INVERTED_BLACK_HOLE_GLOW_PATH = "images/game/invertedBlackHole.png";
}